...
export default forwardRef(({}, ref) => {
    ...
    useEffect(() => {
        getBedrockKnowledgeBases().then(kbs => {
            const kbOptions = kbs.map(kb => ({ label: kb.name, value: kb.knowledgeBaseId, iconName: "settings", description: kb.description, tags: ["Updated: "+ kb.status, "Updated: " + formatDates(kb.updatedAt) ]})) 
